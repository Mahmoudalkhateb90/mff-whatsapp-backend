...
const translations: Translations = {
  en: {
    ...
    userIdNotFoundReLogin: 'User identity not found. Please log in again.',
    ...
    generatingQRAndChecking: 'Generating QR code and verifying session...',
    ...
    sending: 'Sending...',
    sendingSingleMessage: 'Sending message...',
    ...
    processingAndStartingCampaign: 'Processing file and launching campaign...',
  ...
  ar: {
    ...
    userIdNotFoundReLogin: 'لم يتم العثور على المعرف - يرجى إعادة تسجيل الدخول',
    viewLogDetails: 'عرض تفاصيل الخطأ',
    saving: 'جاري الحفظ...',
    deleting: 'جاري الحذف...',
    // Modals
    ...
    generatingQRAndChecking: 'جاري إنشاء كود الـ QR والتحقق من الجلسة...',
    ...
    sendingSingleMessage: 'جاري إرسال الرسالة...',
    ...
    processingAndStartingCampaign: 'جاري معالجة الملف وإطلاق الحملة...',
    ...
    stoppingCampaign: 'جاري إيقاف الحملة...',
